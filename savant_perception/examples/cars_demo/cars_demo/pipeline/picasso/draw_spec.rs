...
//!
//! Lives under [`crate::cars_demo::pipeline::picasso`] because the
...
/// [`crate::cars_demo::pipeline::infer::model::DETECTION_NAMESPACE`].
pub const DRAW_NAMESPACE: &str = crate::cars_demo::pipeline::infer::model::DETECTION_NAMESPACE;
...
/// [`crate::cars_demo::pipeline::infer::model::DETECTION_NAMESPACE`] — never sees these
...
/// [`crate::cars_demo::pipeline`]) because:
/// - inference's batch formation uses `RoiKind::FullFrame` so the overlay
///   is invisible there,
/// - tracker's batch formation filters by
///   [`crate::cars_demo::pipeline::infer::model::DETECTION_NAMESPACE`] so the overlay
