...
//!   installed on [`NvInfer`](savant_perception::stages::NvInfer)
//!   via its [`on_inference`](savant_perception::stages::NvInferBuilder::on_inference)
...
//!   defaults ([`NvInfer::default_on_source_eos`](savant_perception::stages::NvInfer::default_on_source_eos)
//!   and [`NvInfer::default_on_error`](savant_perception::stages::NvInfer::default_on_error)),
...
// that takes the std types.  The rest of `cars_demo` uses
// `hashbrown`.
...
/// [`NvInfer`](savant_perception::stages::NvInfer)) owns the
...
/// [`NvInfer::default_on_source_eos`](savant_perception::stages::NvInfer::default_on_source_eos)
/// and [`NvInfer::default_on_error`](savant_perception::stages::NvInfer::default_on_error) —
