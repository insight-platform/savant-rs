//! YOLO-11n model configuration for the `cars_demo` sample.
//!
...
//! `savant_perception/assets/cache/yolo11n/<platform_tag>/` and reused
...
// the std type.  The rest of `cars_demo` uses `hashbrown`.
...
/// (`savant_perception/assets/cache/yolo11n/<platform_tag>/`) — see
