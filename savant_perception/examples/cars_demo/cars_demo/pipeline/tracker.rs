//! NvDCF tracker helpers for the `cars_demo` sample.
//!
...
//! [`NvTracker`](savant_perception::stages::NvTracker),
...
//! source, and the stage dispatches `Eos` to
//! [`NvTracker::default_on_source_eos`](savant_perception::stages::NvTracker::default_on_source_eos)
...
use crate::assets;
use crate::cars_demo::pipeline::infer::model::DETECTION_NAMESPACE;
...
/// [`NvTracker`](savant_perception::stages::NvTracker)) owns the
...
/// [`NvTracker::default_on_source_eos`](savant_perception::stages::NvTracker::default_on_source_eos)
/// and [`NvTracker::default_on_error`](savant_perception::stages::NvTracker::default_on_error) —
