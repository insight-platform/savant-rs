...
from savant_rs.primitives.geometry import BBox, RBBox, associate_bboxes
...
associations = associate_bboxes(
    [face_bb1.as_rbbox(), face_bb2.as_rbbox()],
    [body_bb1.as_rbbox(), body_bb2.as_rbbox()],
