//! Integration tests for [`NonUniformBatch`] (zero-copy, nvstreammux2-style).

mod common;

use deepstream_buffers::{
    extract_nvbufsurface, BufferGenerator, NonUniformBatch, NvBufSurfaceMemType, SavantIdMeta,
    SavantIdMetaKind, SharedBuffer, SurfaceView, VideoFormat,
};

fn make_gen(format: VideoFormat, w: u32, h: u32) -> BufferGenerator {
...
fn test_heterogeneous_batch_create() {
    common::init();
    let batch = NonUniformBatch::new(0);
