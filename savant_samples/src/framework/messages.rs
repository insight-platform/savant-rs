...
//!    [`Dispatch`](crate::framework::Dispatch) impl to a
//!    [`ResetStreamPayload`] and dispatch via
//!    [`Handler<ResetStreamPayload>`](crate::framework::Handler).
//! 3. Send the variant from any actor that has an
//!    [`Addr`](crate::framework::Addr) of the tracker.
//!
//! The tracker's [`NvTracker`](crate::framework::templates::NvTracker)
...
//! [`ShutdownHint`](crate::framework::ShutdownHint), which classifies
...
/// `source_id`.
///
/// Handled by [`NvTracker`](crate::framework::templates::NvTracker)
...
/// Request a [`Picasso`](crate::framework::templates::Picasso)
...
/// [`Picasso`](crate::framework::templates::Picasso).
///
...
/// payload and dispatches via [`Handler<SourceEosPayload>`](crate::framework::Handler).
...
/// [`ShutdownHint::Graceful`](crate::framework::ShutdownHint::Graceful):
