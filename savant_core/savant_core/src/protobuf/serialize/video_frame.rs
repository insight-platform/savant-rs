...
fn track_state_from_pb(v: i32) -> TrackState {
    match generated::TrackState::try_from(v) {
        Ok(generated::TrackState::Active) => TrackState::Active,
        Ok(generated::TrackState::Inactive) => TrackState::Inactive,
        Ok(generated::TrackState::Tentative) => TrackState::Tentative,
        Ok(generated::TrackState::Projected) => TrackState::Projected,
        _ => TrackState::Empty,
    }
}
...
fn misc_track_category_from_pb(v: i32) -> MiscTrackCategory {
    match generated::MiscTrackCategory::try_from(v) {
        Ok(generated::MiscTrackCategory::MiscTrackTerminated) => MiscTrackCategory::Terminated,
        Ok(generated::MiscTrackCategory::MiscTrackPastFrame) => MiscTrackCategory::PastFrame,
        _ => MiscTrackCategory::Shadow,
    }
}
...
fn misc_track_frame_from_pb(f: &generated::MiscTrackFrame) -> MiscTrackFrame {
    MiscTrackFrame {
        frame_num: f.frame_num,
        bbox_left: f.bbox_left,
        bbox_top: f.bbox_top,
...
fn misc_track_data_from_pb(d: &generated::MiscTrackData) -> MiscTrackData {
    MiscTrackData {
        object_id: d.object_id,
        class_id: d.class_id as u16,
        label: d.label.clone(),
        source_id: d.source_id.clone(),
        category: misc_track_category_from_pb(d.category),
        frames: d.frames.iter().map(misc_track_frame_from_pb).collect(),
    }
}
