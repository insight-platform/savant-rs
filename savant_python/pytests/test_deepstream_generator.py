"""Tests for DsNvSurfaceBufferGenerator — require CUDA/DeepStream runtime."""
...
class TestGeneratorConstruction:
    ...
    def test_nv12_1920x1080(self):
        gen = ds.DsNvSurfaceBufferGenerator("NV12", 1920, 1080)
        assert gen is not None

    def test_custom_fps(self):
        gen = ds.DsNvSurfaceBufferGenerator("RGBA", 320, 240, fps_num=60, fps_den=1)
        assert gen is not None
