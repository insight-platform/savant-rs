...
pub fn save_message_gil(message: &Message, no_gil: bool) -> Vec<u8> {
    release_gil!(no_gil, || {
        savant_core::message::save_message(&message.0)
    })
}

/// Save a message to a protobuf byte array. The function is optionally GIL-free.
///
/// Parameters
/// ----------
/// message: savant_rs.primitives.Message
...
///
#[pyfunction]
#[pyo3(name = "save_pb_message")]
#[pyo3(signature = (message, no_gil=true))]
pub fn save_pb_message_gil(message: &Message, no_gil: bool) -> PyResult<Vec<u8>> {
    release_gil!(no_gil, || {
        savant_core::protobuf::serialize(&message.0)
...
/// -------
/// ByteBuffer
///   The byte buffer containing the message in the protobuf format
///
/// Raises
/// ------
/// :class:`pyo3.exceptions.PyException`
...
///
#[pyfunction]
#[pyo3(name = "save_pb_message_to_bytebuffer")]
#[pyo3(signature = (message, with_hash=true, no_gil=true))]
pub fn save_pb_message_to_bytebuffer_gil(
    message: &Message,
    with_hash: bool,
    no_gil: bool,
) -> PyResult<ByteBuffer> {
    release_gil!(no_gil, || {
        let m = savant_core::protobuf::serialize(&message.0)
            .map_err(|e| pyo3::exceptions::PyException::new_err(format!("{:?}", e)))?;
        let hash_opt = if with_hash { Some(fast_hash(&m)) } else { None };
...
/// Save a message to python bytes as protobuf. The function is optionally GIL-free.
///
/// Parameters
/// ----------
/// message: savant_rs.primitives.Message
...
///
#[pyfunction]
#[pyo3(name = "save_pb_message_to_bytes")]
#[pyo3(signature = (message, no_gil=true))]
pub fn save_pb_message_to_bytes_gil(message: &Message, no_gil: bool) -> PyResult<PyObject> {
