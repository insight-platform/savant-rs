...
class NvTrackerConfig:
    ...
    @property
    def tracker_width(self) -> int: ...

    @property
    def tracker_height(self) -> int: ...
...
@final
class NvTrackerOutput:
    """One item from :meth:`NvTracker.recv` / :meth:`NvTracker.recv_timeout` / :meth:`NvTracker.try_recv`."""
    ...
    def as_tracking(self) -> Optional[TrackerOutput]: ...
    @property
...
@final
class NvTracker:
    def __init__(self, config: NvTrackerConfig) -> None: ...
    ...
    def recv(self) -> NvTrackerOutput: ...
    def recv_timeout(self, timeout_ms: int) -> Optional[NvTrackerOutput]: ...
    def try_recv(self) -> Optional[NvTrackerOutput]: ...
    ...
    def graceful_shutdown(self, timeout_ms: int) -> List[NvTrackerOutput]: ...
...
class NvTrackerBatchingOperator:
    ...
    def reset_stream(self, source_id: str) -> None: ...
    def send_eos(self, source_id: str) -> None: ...
    def graceful_shutdown(self, timeout_ms: int) -> List[TrackerOperatorOutput]: ...
    def shutdown(self) -> None: ...
