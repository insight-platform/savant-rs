...
def search_attributes(ns: Optional[str], name: Optional[str]) -> List[Attribute]: ...


# pub fn search_keys(ns: &Option<String>, name: &Option<String>) -> Vec<(String, String)>
def search_keys(ns: Optional[str], name: Optional[str]) -> List[str]: ...


# pub fn del_attributes(ns: &Option<String>, name: &Option<String>)
def del_attributes(ns: Optional[str], name: Optional[str]) -> None: ...
