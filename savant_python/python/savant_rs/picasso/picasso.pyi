...
class EncoderConfig:
    ...
    @format.setter
    def format(self, value: VideoFormat) -> None: ...

    @property
    def fps_num(self) -> int: ...
    @fps_num.setter
    def fps_num(self, value: int) -> None: ...

    @property
    def fps_den(self) -> int: ...
    @fps_den.setter
    def fps_den(self, value: int) -> None: ...

    @property
    def gpu_id(self) -> int: ...
    @gpu_id.setter
    def gpu_id(self, value: int) -> None: ...

    @property
    def mem_type(self) -> MemType: ...
    @mem_type.setter
    def mem_type(self, value: MemType) -> None: ...

    @property
    def encoder_params(self) -> Optional[EncoderProperties]: ...
    @encoder_params.setter
    def encoder_params(self, value: Optional[EncoderProperties]) -> None: ...
