...
def forget_video_id(source_id: str) -> None: ...
def relative_time_video_id(id: str, offset_millis: int) -> str: ...
def video_id_lower_bound(source_id: str, ts_ms: int) -> str: ...
def video_id_upper_bound(source_id: str, ts_ms: int) -> str: ...
