...
class TopicPrefixSpec:
    @staticmethod
    def source_id(id: str) -> TopicPrefixSpec: ...
    @staticmethod
...
class WriterConfigBuilder:
    ...
    def with_fix_ipc_permissions(self, fix_ipc_permissions: Optional[int] = None): ...
    def with_map_config(self, map: dict[str, Any]) -> None: ...
...
class ReaderConfig:
    ...
    def fix_ipc_permissions(self) -> Optional[int]: ...
    @property
    def source_blacklist_size(self) -> int: ...
    @property
    def source_blacklist_ttl(self) -> int: ...

class ReaderConfigBuilder:
    def __init__(self, url: str): ...
    def with_receive_timeout(self, receive_timeout: int): ...
    def with_receive_hwm(self, receive_hwm: int): ...
    def with_topic_prefix_spec(self, topic_prefix_spec: TopicPrefixSpec): ...
    def with_routing_cache_size(self, size: int): ...
    def with_fix_ipc_permissions(self, permissions: Optional[int] = None): ...
    def with_source_blacklist_size(self, size: int): ...
    def with_source_blacklist_ttl(self, ttl: int): ...
    def with_map_config(self, map: dict[str, Any]) -> None: ...
...
class ReaderResultMessage:
    ...
    def data(self, index: int) -> Optional[bytes]: ...
...
class BlockingWriter:
    ...
    def send_eos(
        self, source_id: str, topic: Optional[str] = None
    ) -> Union[
        WriterResultSendTimeout,
        WriterResultAckTimeout,
        WriterResultAck,
    ...
    def send_message(
        self, topic: str, message: Message, extra: bytes
    ) -> Union[
        WriterResultSendTimeout,
        WriterResultAckTimeout,
        WriterResultAck,
...
class BlockingReader:
    ...
    def blacklist_source(self, source_id: bytes) -> None: ...
    def is_blacklisted(self, source_id: bytes) -> bool: ...
...
class NonBlockingWriter:
    ...
    def send_message(self, topic: str, message: Message, extra: bytes) -> WriteOperationResult: ...
