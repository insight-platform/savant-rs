...
#[pyfunction]
pub(crate) fn utility_resolver_name() -> String {
    savant_core::eval_resolvers::utility_resolver_name()
}

#[pyfunction]
pub(crate) fn env_resolver_name() -> String {
    savant_core::eval_resolvers::env_resolver_name()
}

#[pyfunction]
pub(crate) fn config_resolver_name() -> String {
    savant_core::eval_resolvers::config_resolver_name()
}

#[pyfunction]
pub(crate) fn etcd_resolver_name() -> String {
...
pub(crate) fn register_etcd_resolver(
    hosts: Vec<String>,
